...
class StudentCreateEditRequest extends FormRequest
{
    /**
    ...
    public function rules(): array
    {
        return [
            ...
            'user.father_name' => 'required|string',
            'user.national_id' => 'required|numeric',
            'user.phone_number' => 'required|string',
            'user.email' => 'required|string|email',

            'personal_data.birth_place' => 'required|string',
            'personal_data.birth_date' => 'required|date',
            'personal_data.religion' => 'required|string',
            'personal_data.gender' => 'required|string',
            'personal_data.is_married' => 'required|boolean',
            'personal_data.parent_phone_number' => 'required|string',
            'personal_data.emergency_phone_number' => 'required|string',
